...
from backend.routes import admin, auth, features, insights, markets, positions, trade_history, trades, users
...
def create_app() -> FastAPI:
    app = FastAPI(title="Knightshi API", version="0.1.0", lifespan=lifespan)
